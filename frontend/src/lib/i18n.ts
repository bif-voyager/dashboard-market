...
export const translations = {
  en: {
    ...
    dataQualityNotice:
      "Data is sourced from Dune saved-query results and cached locally; freshness follows the latest successful sync.",
  ...
  ru: {
    ...
    dataQualityNotice:
      "Данные берутся из сохранённых Dune-запросов и кэшируются локально; актуальность зависит от последней успешной синхронизации.",
    failedToLoad: "Не удалось загрузить данные дашборда.",
    range: "Диапазон",
    allTime: "Всё время",
    asOf: "На дату",
    categories: "Категории",
    filterAppliesTo: "К чему применять категории",
    applyBoth: "Обе биржи",
    ...
    chartBars: "Столбцы",
    chartStacked: "Стек",
    chartInteractionHint: "Колесо мыши приближает, drag сдвигает, double-click сбрасывает.",
